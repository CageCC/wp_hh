...
function shortcode_cws_cta($attr, $content = null) {
	...
	$output .= "<div class='content_wrapper'><div class='text_part'>" . ( $title ? "<div class='title'>$title</div>" : "" ) . do_shortcode($content) . "</div><div class='button_part'><a class='cws_button medium' href='$link' " . ($target ? " target='_blank'" : "" ) . ">$button_text</a></div></div>";
	$output .= '</div>';
