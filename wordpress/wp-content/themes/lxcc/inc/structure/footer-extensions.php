...
/* end interface_footer_widget_area */
...
} /* end interface_footer_div_close */
...
/* end interface_open_sitegenerator_div */
...
function interface_close_sitegenerator_div() {
	echo '</div><!-- .container --></div><!-- #site-generator -->';
}
/* end interface_close_sitegenerator_div */
