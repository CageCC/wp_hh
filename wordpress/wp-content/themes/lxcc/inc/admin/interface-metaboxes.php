...
function interface_add_custom_box() {
	...
	add_meta_box(
		...
		//Callback function	
		'interface_sidebar_layout',  
		//show metabox in pages                 							
		'page'                                          							
	); 
...
$sidebar_layout = array(
	'default-sidebar' 	=> array(
		...
		'value' 		=> 'default',
		'label' 		=> __( 'Default Layout Set in', 'interface' ).' '.'<a href="'.get_bloginfo('url').'/wp-admin/themes.php?page=theme_options" target="_blank">'.__( 'Theme Settings', 'interface' ).'</a>',
		'thumbnail' => ' '
	),
...
/* end interface_save_custom_meta */